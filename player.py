...
class Player():
    ...
    def __init__(self, hf_game):
        ...
        self.screen_size = hf_game.screen_size
        # load the player and its rect
        self.image = pygame.image.load("pcc\part2_projects\project1_alien_invasion\TRY\HelicopterFighter\images\player.png")
    ...
    def update(self):
        ...
        elif self.moving_right and self.rect.midright < self.screen_size) / 4:
